...
# Script para configurar Nginx + Certbot para api.al-eon.com
# Ejecutar como root en EC2

set -e

echo "🚀 Configurando Nginx y SSL para api.al-eon.com..."
...
cp /path/to/api.al-eon.com.conf /etc/nginx/sites-available/
ln -sf /etc/nginx/sites-available/api.al-eon.com.conf /etc/nginx/sites-enabled/
...
certbot --nginx -d api.al-eon.com --non-interactive --agree-tos --email admin@al-eon.com
...
echo "curl -i -X OPTIONS https://api.al-eon.com/api/ai/chat \\"
echo "  -H \"Origin: https://al-eon.com\" \\"
echo "  -H \"Access-Control-Request-Method: POST\" \\"
echo "  -H \"Access-Control-Request-Headers: content-type\""
echo ""
echo "🔗 Tu API está ahora disponible en: https://api.al-eon.com"