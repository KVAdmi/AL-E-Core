 ...
 */
export async function getExchangeRateUSDToMXN(): Promise<number | null> {
  try {
 ...
 */
export async function getWeatherByCity(city: string): Promise<any | null> {
 ...
 */
export async function getGenericSearch(query: string): Promise<any | null> {
 ...
 */
export async function getNewsByTopic(topic: string): Promise<any | null> {
